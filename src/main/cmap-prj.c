...
static const char * hello_world_cmap =
  ...
  "  };\n"
  "\n"
  "  LOCAL helloName = function()/t/\n"
  "  {\n"
  "    hello(\"Test\"/t/);\n"
  "  };\n"
  "\n"
  "  LOCAL job = new cmap.scheduler.job{helloName}/t/;\n"
  "  job.schedule();\n"
  "}\n";
...
const char * makefile =
  ...
  ".PHONY: clean\n"
  "\n"
  "CMAP_HOME = $(HOME)/tools/cmap/" VERSION "\n"
  "CMAP_MAIN = $(CMAP_HOME)/bin/cmap-main\n"
  "\n"
  "CFLAGS = -Wall -I$(CMAP_HOME)/include\n"
  "LDFLAGS = -L$(CMAP_HOME)/lib -lcmap\n"
  "\n"
