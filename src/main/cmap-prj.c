...
static const char * hello_world_cmap =
  ...
  "{\n"
  "  LOCAL size = cmap.cli.args.size();\n"
  "  if(size >= 2#local#) { LOCAL name = cmap.cli.args[[1]]; }\n"
  "  if(name == null) { LOCAL name = \"World\"#t#; }\n"
  "\n"
  ...
  "    else if(this.nb == 2#local#) { this.deepDeleteNoRef(); return; }\n"
  "    else { this.nb.inc(); }\n"
  "\n"
  "    this.schedule();\n"
  "  };\n"
