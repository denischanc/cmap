...
#define CMAP_TREE_RUNNER_INIT(prefix, internal) \
CMAP_TREE_RUNNER_NAME(prefix).internal_ = internal;

#define CMAP_TREE_FINDFN(prefix, tree) \
  cmap_tree_find(&CMAP_TREE_RUNNER_NAME(prefix), tree)

#define CMAP_TREE_ADDFN(prefix, tree, node) \
...
#define CMAP_TREE_APPLYFN(prefix, tree, apply, ge_first) \
