...
{ \
 ...
 \
const CMAP_OP_HANDLER cmap_op_handler_int_##name##_public = {op_##name};
...
{ \
 ...
 \
const CMAP_OP_HANDLER_SELF cmap_op_handler_int_##name##_public = {op_##name};
...
{ \
 ...
 \
const CMAP_OP_HANDLER_UNIQUE cmap_op_handler_int_##name##_public = {op_##name};
