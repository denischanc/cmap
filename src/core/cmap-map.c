...
{
  CMAP_MEM_ALLOC_PTR(map, CMAP_MAP);
...
static void clean(CMAP_MAP * this)
{
  ...
  CMAP_STREE_QUICKAPPLYFN(internal -> entry_stree, clean_apply,
    &internal -> ghost);
...
static void delete(CMAP_LIFECYCLE * this)
{
  ...
  DELETE_APPLY_DATA data = {this, internal -> ghost};
