...
#define CMAP_LIST_ADD(list, i, val, proc_ctx) \
  cmap_list_add(list, i, (CMAP_MAP *)val, proc_ctx)
#define CMAP_LIST_RM(list, i, proc_ctx) cmap_list_rm(list, i, proc_ctx)

#define CMAP_LIST_PUSH(list, val, proc_ctx) \
  cmap_list_push(list, (CMAP_MAP *)val, proc_ctx)
#define CMAP_LIST_POP(list, proc_ctx) cmap_list_pop(list, proc_ctx)

#define CMAP_LIST_UNSHIFT(list, val, proc_ctx) \
  cmap_list_unshift(list, (CMAP_MAP *)val, proc_ctx)
